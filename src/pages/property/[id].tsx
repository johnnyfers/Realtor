...
import ImageScrollbar from '../../components/image-scroll-bar';
import { IProperty } from '@/components/property';

export default function PropertyDetails({  furnishingStatus, photos, type, amenities, description, purpose, title, isVerified, rentFrequency, price, agency, area, baths, rooms } : IProperty) {
    return (
